...
import { 
  ...
  GraduationCap, Menu, X,IndianRupee
} from 'lucide-react';
  ...
  <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6 animate-fade-in max-w-5xl">
    ...
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 border-b border-gray-100 pb-4">
      ...
      <div className="flex flex-wrap gap-2 w-full md:w-auto">
        <button onClick={onExport} className="flex-1 md:flex-none bg-green-50 text-green-700 border border-green-200 px-3 md:px-4 py-2 rounded-lg flex justify-center items-center gap-2 font-bold hover:bg-green-100 transition-colors shadow-sm text-sm md:text-base">
          <Download size={16} /> Export CSV
        </button>
        <button onClick={onClear} className="flex-1 md:flex-none bg-red-50 text-red-700 border border-red-200 px-3 md:px-4 py-2 rounded-lg flex justify-center items-center gap-2 font-bold hover:bg-red-100 transition-colors shadow-sm text-sm md:text-base">
          ...
          <div key={msg._id} className="bg-gray-50/50 rounded-xl border border-gray-200 p-4 md:p-5 hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start mb-3 border-b border-gray-200 pb-3">
              <div className="flex items-center gap-3">
                <div className={`h-10 w-10 text-white rounded-full flex items-center justify-center font-bold shrink-0 ${msg.sender?.role === 'admin' ? 'bg-gray-900' : 'bg-purple-600'}`}>
              ...
              <span className="text-[10px] md:text-xs text-gray-500 bg-white px-2 py-1 rounded-md border flex items-center gap-1 shadow-sm shrink-0">
