...
// =========================================================================
const safeDeleteMany = async (modelPath) => {
    try {
        ...
        // If file is not found, DO NOT crash. Just silently return false.
        return false;
    }
};
...
const getAdminStats = async (req, res) => {
    try {
        ...
        res.json({ totalStudents, totalTeachers, classesToday: 0 });
...
module.exports = {
    ...
    purgeSystemAll, wipeAttendance, deleteAllMessages, wipeExams, wipeFees, wipeGallery        
};